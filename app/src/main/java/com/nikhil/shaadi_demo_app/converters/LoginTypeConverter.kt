...
class LoginTypeConverter {
    ...
    private val adapter = moshi.adapter(Profiles.Result.Login::class.java)

    @TypeConverter
    fun fromString(value: String?): Profiles.Result.Login? {
        return adapter.fromJson(value)
    }

    @TypeConverter
    fun fromList(value: Profiles.Result.Login?): String? {
