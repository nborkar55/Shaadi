...
class IdTypeConverter {
    ...
    private val adapter = moshi.adapter(Profiles.Result.Id::class.java)

    @TypeConverter
    fun fromString(value: String?): Profiles.Result.Id? {
        return adapter.fromJson(value)
    }

    @TypeConverter
    fun fromList(value: Profiles.Result.Id?): String? {
